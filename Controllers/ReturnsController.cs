...
namespace AppMovie.Controllers
{
    ...
    public class ReturnsController : Controller
    {
        ...
        {
            var appMovieContext = _context.Return.Include(@return => @return.Partner);
            ...
            if (ModelState.IsValid)
            {
                using (var transaccion = _context.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        var moviesTempReturn = (from a in _context.ReturnDetailTemp select a).ToList();
                        foreach (var item in moviesTempReturn)
                        {
                            ...
                            _context.ReturnDetailTemp.RemoveRange(moviesTempReturn);
